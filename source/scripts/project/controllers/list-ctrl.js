angMod.controller( "ListCtrl", [ "$scope", "$rootScope", "$filter", "ngDialog", "UrlHelper", "API",
    function ( $scope, $rootScope, $filter, ngDialog, UrlHelper, API )
    {
        ...
        $scope.getList = function () {
            ...
            .error( function ( data ) {
                console.warn( "Oops, there was an issue retrieving companies" );
            });
        };
        ...
        $scope.updateItem = function ( item ) {
                ...
                .error( function ( data ) {
                    console.warn( "Oops, there was a problem updating the customer" );
                });
        };
        ...
        $scope.deleteItem = function ( item ) {
            ...
            .error( function ( data ) {
                console.warn( "Oops, There was an issue deleting the customer" );
            });
        };
